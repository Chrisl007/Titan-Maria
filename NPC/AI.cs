...
public class AI : MonoBehaviour
{
    ...
    private float floatHeight = 0.0f; //If it can fly/hover, you need to let the AI know how high off the ground it should be.
    ...
    bool TargetIsInSight()
    {
        ...
        RaycastHit sight;
        Debug.DrawRay(transform.position, target.position, Color.red);//raycast for sight
    ...
    /// <summary>
    /// random movement behaviour and walk new path
    /// </summary>
    ...
    void MoveTowards(Vector3 direction)
    {
        ...
        //direction.y = 0;
        direction.y = transform.localEulerAngles.y;
        int speed = walkSpeed;
    ...
    void MonitorGravity()
    {
        ...
        if ((!canFly) && (floatHeight > 0.0f))
        {
            ...
            else
            {
                ...
                RaycastHit floatCheck;
                Debug.DrawRay(transform.position, -Vector3.up * floatHeight, Color.blue);//raycast for float
